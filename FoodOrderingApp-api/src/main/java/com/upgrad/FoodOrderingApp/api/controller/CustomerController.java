...
public class CustomerController {
   ...
   *
   * @param request Customer Signup Request
   * @throws SignUpRestrictedException when one ore more of first name, password, email & contact
   *     number are missing on the request
   */
